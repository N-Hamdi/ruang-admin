          ...
          <div class="row">
            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <a href="add-user" class="btn btn-success">Tambah User</a>
                </div>
                <div class="table-responsive p-3">
                  <?php
                  include_once('../connect.php');
                  $datagudang = mysqli_query($koneksi, "SELECT * FROM users");
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            if ($username != 'admin' && $name != 'admin') { ?>
                              <a href="edituser?id=<?php echo $ID; ?>" class=" btn btn-warning">Edit</a>
                              <a href="hapususer?id=<?php echo $ID; ?>" class="btn btn-danger" onclick="return confirm('Hapus data ini ?')">Delete</a>
                            <?php }
                            ?>
                          </td>
