...
if ($_SESSION['username'] != $_GET['username']) {
    echo "<script>alert('Anda tidak berhak melakukannya');window.history.back()</script>";
}
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Nex - Ganti Password</title>
                                ...
                                <div class="card-body">
                                    <form action="changepw" method="POST">
                                        <div class="form-group">
                                            ...
                                            $data = mysqli_query($koneksi, "SELECT * FROM users WHERE id='$ID' AND username='$username'");
