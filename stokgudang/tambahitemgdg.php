      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Tambah Barang Gudang</h1>
            <ol class="breadcrumb">
                    ...
                    <div class="form-group">
                      <div class="form-group" id="simple-date1">
                        ...
                        <div class="input-group date">
                          ...
                          <input type="text" class="form-control inputdate" placeholder="Tanggal/Bulan/Tahun" id="inputdate" name="inputdate">
                        </div>
                      </div>
