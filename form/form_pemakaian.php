      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Form Pemakaian Material</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Home</a></li>
              <li class="breadcrumb-item">Form</li>
              <li class="breadcrumb-item active" aria-current="page">Form Pemakaian Material</li>
            </ol>
          </div>
                ...
                <div class="card-body">
                  <form action="" method="POST" id="insert_form">
                    ...
                    <div class="form-group">
                      ...
                      $formid = $data['kodeMax'];
                      $fym = substr("$formid", 0, -2);
                      $nextKode = (int) substr($formid, 7);
                      // $nextKode++;
                      $t = time();
                      $date = date("Ym", $t);
                      if ($fym == $date) {
                      ...
                      <table class="table table-bordered" id="item_table">
                        <thead>
                          <tr>
                            ...
                            <th>Jumlah</th>
                            <th>Keterangan</th>
                            <th><button type="button" name="add" id="add" class="btn btn-success btn-sm add"><span class="glyphicon glyphicon-plus"></span>Tambah</button></th>
                          </tr>
                        </thead>
                        <tbody>
  ...
  <script>
    $(document).ready(function() {
      ...
      function add_input_field(count) {
        ...
        html += '<td><input type="number" name="item_qty[]" class="form-control item_qty" /><input type="hidden" name="input_date[]" class="form-control input_date" /></td>';
          ...
          $.ajax({
            ...
            success: function(data) {
              ...
              if (data == 'ok') {
                ...
                window.location = 'tampilinputform'
                // $('#formid').val("#formid")
